...
- [tscircuit/tscircuit-autorouter#2462](https://github.com/tscircuit/tscircuit-autorouter/pull/2462) — Solver7 fail-closed on same-layer different-connection shorts (`#1964`). Snapshots refreshed from the fail-closed visualization.
